...
- [x] Step C: `business-logic-model.md`（接続登録・スキーマ取込のフロー、方言吸収の適用ポイント）を作成する
- [x] Step D: `domain-entities.md`（RdbmsConnection、SchemaSnapshot/Table/Column/Constraint等）を作成する
