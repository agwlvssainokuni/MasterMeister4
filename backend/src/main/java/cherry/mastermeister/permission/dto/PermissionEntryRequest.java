...
/**
 * frontend-components.md §2。{@code PUT /api/admin/permissions/{connectionId}}のリクエストボディ。
 * tableName/columnNameは任意（スキーマ／テーブル階層の設定時はnull）。
 */
public record PermissionEntryRequest(
        ...
        String tableName,
        String columnName,
        @NotNull PrimaryPermission primaryPermission,
