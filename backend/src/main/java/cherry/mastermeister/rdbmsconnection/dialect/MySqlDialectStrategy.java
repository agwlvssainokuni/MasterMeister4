...
@Component
public class MySqlDialectStrategy implements RdbmsDialectStrategy {
    ...
    public boolean requiresSchemaSwitch() {
        // MySQLは「データベース」がスキーマに相当する単位として扱われるため切替不要
        return false;
    }

    @Override
    public void applySchemaSwitch(Connection connection, String schema) {
        throw new UnsupportedOperationException("MySQL does not support schema switch");
    }
